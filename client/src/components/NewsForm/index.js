      ...
      <CardBody>
        <Form onSubmit={(evt) => props.updateElement(evt)}>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="textarea" onChange={props.onInputChange} value={news.title} name="title" id="textarea-input"
                     rows="2"
                     placeholder="Content..."/>
            </Col>
          </FormGroup>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="text-input" onChange={props.onInputChange} value={news.link} name="link"
                     placeholder="link"/>
            </Col>
          </FormGroup>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="text-input" onChange={props.onInputChange} value={news.date} name="date"
                     placeholder="date"/>
            </Col>
          </FormGroup>
          <FormGroup row>
