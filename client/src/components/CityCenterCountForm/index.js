      ...
      <CardBody>
        <Form onSubmit={(evt) => props.updateElement(evt)}>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="text-input" onChange={props.onInputChange} value={nameOfComponent.city} name="city"
                     placeholder="city"/>
            </Col>
          ...
          <Col xs="12" md="9">
            <Input type="text" id="text-input" onChange={props.onInputChange} value={nameOfComponent.count} name="count"
                   placeholder="count"/>
          </Col>
        </FormGroup> </Form>
      </CardBody>
