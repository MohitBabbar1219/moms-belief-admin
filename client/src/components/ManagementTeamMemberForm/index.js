...
const ManagementTeamMemberForm = (props) => {
  const nameOfComponent = props.managementTeamMember;
  return (<Card>
      <CardHeader>
...
<FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="text-input" onChange={props.onInputChange} value={nameOfComponent.name} name="name" placeholder="name"/>
            </Col>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="text-input" onChange={props.onInputChange} value={nameOfComponent.designation} name="designation" placeholder="designation"/>
            </Col>
            <Col md="3">
              <Label htmlFor="textarea-input">About</Label>
            </Col>
            <Col xs="12" md="9">
              <Input type="textarea" onChange={props.onInputChange} value={nameOfComponent.about} name="about" id="textarea-input" rows="9"
                     placeholder="about..."/>
            </Col>
          </FormGroup>
        </Form>
