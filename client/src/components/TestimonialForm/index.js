      ...
      <CardBody>
        <Form onSubmit={(evt) => props.updateElement(evt)}>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="textarea" onChange={props.onInputChange} value={testimonial.content} name="content"
          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="text-input" onChange={props.onInputChange} value={testimonial.author} name="author"
                     placeholder="Author"/>
            </Col>
          </FormGroup>
          <FormGroup row>
