...
class SponsorCards extends Component {
  constructor(props) {
    super(props);
  ...
  updateHomeElements = () => {
    axios.get('/api/home/sponsors').then(testimonials => {
      console.log(testimonials.data);
      this.setState({sponsors: testimonials.data.data});
    });
  };
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <button className="btn btn-primary m-4" onClick={() => this.toggleNew("sponsors")}>Add new
          sponsor
        </button>
        <Row>
          {testimonialSection}
