...
class ManagementTeamMemberCards extends Component {
  constructor(props) {
    super(props);
  ...
  updateHomeElements = () => {
    axios.get('/api/aboutUs/managementTeamMembers').then(testimonials => {
      console.log(testimonials.data);
      this.setState({managementTeamMembers: testimonials.data.data});
    });
  };
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <button className="btn btn-primary m-4" onClick={() => this.toggleNew("managementTeamMembers")}>Add new
...
export default ManagementTeamMemberCards;
